...
namespace DRBE
{
    public class DRBE_Transmitter
    {
        public List<byte> Raw_data = new List<byte>();

        public UInt16 ID = 0;

        public string Coordinate_system = "Global Frame \\ WGS84"; //
        ...
        public double Initial_Sc_posX = -365;
        public double Initial_Sc_posY = 55690;
        public double Initial_Sc_posZ = 4.7929;
        ...
        public string Window_type= "Hann Window";
        ...
        {
            Coordinate_system = "Global Frame \\ WGS84"; //
            ...
            Initial_Sc_posX = -365;
            Initial_Sc_posY = 55690;
            Initial_Sc_posZ = 4.7929;
        ...
        public string Generate_file_report()
        {
            ...
            result += "Initial Scenario Center Position X: " + "{" + Initial_Sc_posX.ToString() + "}" + "\r\n";
            result += "Initial Scenario Center Position Y: " + "{" + Initial_Sc_posY.ToString() + "}" + "\r\n";
            result += "Initial Scenario Center Position Z: " + "{" + Initial_Sc_posZ.ToString() + "}" + "\r\n";
